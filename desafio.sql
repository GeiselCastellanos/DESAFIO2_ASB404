...
-- Relacionar con los actores
JOIN film_actor fa ON f.film_id = fa.film_id
JOIN actor a ON fa.actor_id = a.actor_id

-- Relacionar con las categorías
...
--Para ver el resultado seria 
SELECT * FROM vista_peliculas_info LIMIT 10;
...
---Para ver el resultado seria 
SELECT * FROM vista_ganancias_pelicula_tienda LIMIT 10;
...
BEGIN
    ...
    SET p_rental_id_out = v_rental_id;
